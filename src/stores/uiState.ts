...
export const useUiStateStore = defineStore("uiState", () => {
    ...
    const currentCategoryListElement =
        ref<possibleCategoryListElements>("ArtistList");
    ...
    const categoryListElementMap: Record<
        possibleCategoryListElements,
        Component
    > = {
    ...
    const trackListUiElement = computed(
        () => trackListElementMap[currentTrackListElement.value],
    );
    const categoryListUiElement = computed(
        () => categoryListElementMap[currentCategoryListElement.value],
    );
    ...
    const setCategoryListUiElement = (
        uiElement: possibleCategoryListElements,
    ) => {
